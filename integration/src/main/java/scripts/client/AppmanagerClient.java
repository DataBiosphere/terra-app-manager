...
import bio.terra.appmanager.client.ApiClient;
...
public class AppmanagerClient extends ApiClient {
   ...
   */
  public AppmanagerClient(ServerSpecification server) throws IOException {
    this(server, null);
  }
   ...
   */
  public AppmanagerClient(ServerSpecification server, TestUserSpecification testUser)
      throws IOException {
